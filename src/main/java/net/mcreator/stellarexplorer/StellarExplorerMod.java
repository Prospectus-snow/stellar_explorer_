package net.mcreator.stellarexplorer;
...
import net.mcreator.stellarexplorer.init.StellarExplorerModTabs;
...
@Mod("stellar_explorer")
public class StellarExplorerMod {
	public static final Logger LOGGER = LogManager.getLogger(StellarExplorerMod.class);
	public static final String MODID = "stellar_explorer";

	public StellarExplorerMod() {
		...
		StellarExplorerModParticleTypes.REGISTRY.register(bus);

		StellarExplorerModMenus.REGISTRY.register(bus);
