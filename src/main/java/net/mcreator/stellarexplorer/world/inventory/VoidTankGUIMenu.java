...
public class VoidTankGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public VoidTankGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StellarExplorerModMenus.VOID_TANK_GUI.get(), id);
