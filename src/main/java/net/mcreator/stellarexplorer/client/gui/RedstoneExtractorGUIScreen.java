...
public class RedstoneExtractorGUIScreen extends AbstractContainerScreen<RedstoneExtractorGUIMenu> {
	private final static HashMap<String, Object> guistate = RedstoneExtractorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public RedstoneExtractorGUIScreen(RedstoneExtractorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("stellar_explorer:textures/screens/redstone_extractor_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("stellar_explorer:textures/screens/work_progress_bar.png"), this.leftPos + 56, this.topPos + 59, Mth.clamp((int) WorkBarOverlayProcedure.execute(world, x, y, z) * 64, 0, 4096), 0, 64, 3, 4160, 3);
