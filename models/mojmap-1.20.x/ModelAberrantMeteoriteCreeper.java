...
public class ModelAberrantMeteoriteCreeper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "aberrantmeteoritecreeper"), "main");
	private final ModelPart leg_all;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg_all = partdefinition.addOrReplaceChild("leg_all", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 15.0F));

		PartDefinition all = leg_all.addOrReplaceChild("all", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, -15.0F));

		PartDefinition body_all = all.addOrReplaceChild("body_all", CubeListBuilder.create(),
				PartPose.offset(0.0F, -14.0F, 0.0F));

		PartDefinition body = body_all
				.addOrReplaceChild("body",
						CubeListBuilder.create().texOffs(0, 71).addBox(-3.0F, -17.0F, -3.0F, 6.0F, 18.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3491F, 0.0F, 0.0F));

		PartDefinition body2 = body.addOrReplaceChild("body2",
				CubeListBuilder.create().texOffs(0, 43).addBox(-3.0F, -22.0F, -3.0F, 6.0F, 22.0F, 6.0F,
						new CubeDeformation(-0.01F)),
				PartPose.offsetAndRotation(0.0F, -17.0F, 0.0F, 1.0036F, 0.0F, 0.0F));

		PartDefinition head = body2.addOrReplaceChild("head", CubeListBuilder.create(),
				PartPose.offset(0.0F, -20.0F, 0.0F));

		PartDefinition head2 = head.addOrReplaceChild("head2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-7.0F, -8.0F, -8.0F, 14.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 22)
						.addBox(-7.0F, 0.0F, -8.0F, 14.0F, 7.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(43, 6).mirror()
						.addBox(-1.0F, -2.5F, 0.0F, 9.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r3 = head2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(42, 0).mirror()
						.addBox(-1.0F, -4.5F, 0.0F, 10.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(7.0F, -4.5F, -1.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition cube_r4 = head2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(43, 6).addBox(-8.0F, -2.5F, 0.0F, 9.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -2.5F, -1.0F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition cube_r6 = head2.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(42, 0).addBox(-9.0F, -4.5F, 0.0F, 10.0F, 6.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, -4.5F, -1.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition right_leg_1 = body_all.addOrReplaceChild("right_leg_1", CubeListBuilder.create(),
				PartPose.offset(-2.5F, -1.0F, -2.0F));

		PartDefinition right_leg_1_1 = right_leg_1.addOrReplaceChild("right_leg_1_1",
				CubeListBuilder.create().texOffs(52, 43).addBox(-2.5F, -1.0F, -2.5F, 5.0F, 12.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg_1_2 = right_leg_1_1.addOrReplaceChild("right_leg_1_2",
				CubeListBuilder.create().texOffs(24, 43)
						.addBox(-3.5F, -1.0F, -3.5F, 7.0F, 24.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(24, 74)
						.addBox(-3.5F, 14.0F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.0F, 0.0F, -1.3963F));

		PartDefinition cube_r7 = right_leg_1_2.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(43, 6).addBox(-8.0F, -2.5F, 0.0F, 9.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, 7.5F, 0.0F, 0.0F, 0.0F, -0.6981F));

		PartDefinition cube_r8 = right_leg_1_2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(42, 0).addBox(-9.0F, -4.5F, 0.0F, 10.0F, 6.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, 3.5F, 0.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition left_leg_1 = body_all.addOrReplaceChild("left_leg_1", CubeListBuilder.create(),
				PartPose.offset(2.5F, -1.0F, -2.0F));

		PartDefinition left_leg_1_1 = left_leg_1.addOrReplaceChild("left_leg_1_1",
				CubeListBuilder.create().texOffs(52, 43).mirror()
						.addBox(-2.5F, -1.0F, -2.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, -0.2618F, -1.9199F));

		PartDefinition left_leg_1_2 = left_leg_1_1.addOrReplaceChild("left_leg_1_2",
				CubeListBuilder.create().texOffs(24, 43).mirror()
						.addBox(-3.5F, -1.0F, -3.5F, 7.0F, 24.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(24, 74).mirror()
						.addBox(-3.5F, 14.0F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.5F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.0F, 0.0F, 1.3963F));

		PartDefinition cube_r9 = left_leg_1_2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(43, 6).mirror()
						.addBox(-1.0F, -2.5F, 0.0F, 9.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.5F, 7.5F, 0.0F, 0.0F, 0.0F, 0.6981F));

		PartDefinition cube_r10 = left_leg_1_2.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(42, 0).mirror()
						.addBox(-1.0F, -4.5F, 0.0F, 10.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.5F, 3.5F, 0.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition right_leg_2 = all.addOrReplaceChild("right_leg_2", CubeListBuilder.create(),
				PartPose.offset(-2.5F, -15.0F, 3.0F));

		PartDefinition right_leg_2_1 = right_leg_2.addOrReplaceChild("right_leg_2_1",
				CubeListBuilder.create().texOffs(52, 43).addBox(-2.5F, -1.0F, -2.5F, 5.0F, 12.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.5236F, -0.2618F, 1.9199F));
		...
		PartDefinition cube_r11 = right_leg_2_2.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(42, 0).addBox(-9.0F, -4.5F, 0.0F, 10.0F, 6.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, 3.5F, 0.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition cube_r12 = right_leg_2_2.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(43, 6).addBox(-8.0F, -2.5F, 0.0F, 9.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, 7.5F, 0.0F, 0.0F, 0.0F, -0.6981F));

		PartDefinition left_leg_2 = all.addOrReplaceChild("left_leg_2", CubeListBuilder.create(),
				PartPose.offset(2.5F, -15.0F, 3.0F));

		PartDefinition left_leg_2_1 = left_leg_2.addOrReplaceChild("left_leg_2_1",
				CubeListBuilder.create().texOffs(52, 43).mirror()
						.addBox(-2.5F, -1.0F, -2.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.5236F, 0.2618F, -1.9199F));
		...
		PartDefinition cube_r13 = left_leg_2_2.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(42, 0).mirror()
						.addBox(-1.0F, -4.5F, 0.0F, 10.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.5F, 3.5F, 0.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition cube_r14 = left_leg_2_2.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(43, 6).mirror()
						.addBox(-1.0F, -2.5F, 0.0F, 9.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.5F, 7.5F, 0.0F, 0.0F, 0.0F, 0.6981F));
